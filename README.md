...
Для обслуживания/очистки данных добавлен сервисный endpoint удаления контента темы:

```
DELETE /api/topics/{topic}/content
```
...
> Используйте осторожно: удаляет все статьи (включая оглавление) для указанной темы.
